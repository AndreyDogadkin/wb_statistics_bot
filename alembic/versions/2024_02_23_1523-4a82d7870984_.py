...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ['user_id'], ['user_account.telegram_id'], ondelete='CASCADE'
        ),
        sa.PrimaryKeyConstraint('id'),
        sa.UniqueConstraint('name', 'user_id', name='uniq_account_name'),
    )
    op.create_table(
        'account_favorites_requests',
        ...
        sa.Column('date_added', sa.DateTime(), nullable=False),
        sa.ForeignKeyConstraint(
            ['wb_account_id'], ['wb_account.id'], ondelete='CASCADE'
        ),
        sa.PrimaryKeyConstraint('id'),
        sa.UniqueConstraint(
            'wb_account_id', 'nm_id', 'period', name='all_columns_uniq'
        ),
    )
    op.create_table(
        'wb_tokens',
